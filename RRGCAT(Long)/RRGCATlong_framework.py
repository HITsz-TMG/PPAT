...
from RRGCATlong_dataset import get_dataloader
from RRGCATlong_model import RRGCATlong_model
...
class RRGCATlong_framework(BaseFramework):
    ...
    def __model_initial(self):
        ...
        opt = self.opt
        model = RRGCATlong_model(opt.model_config, self.logger)
...
def main(opt):
    ...
    framework = RRGCATlong_framework(opt)
