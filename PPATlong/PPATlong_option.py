...
def option():
    ...
    def _model_config():
        ...
        parser.add_argument('--intra_label_weight', default=10.0, type=float, help='loss wright for label==1')
        parser.add_argument('--focusing', default=2, type=int, help='')
        parser.add_argument('--loss_mode', default='focal', help='focal/normal')
        parser.add_argument('--event_emb_mul', default=False, type=str2bool)
        parser.add_argument('--need_cls', default=False, type=str2bool)
        ...
        parser.add_argument('--layer_intra_loss_weight', default=[1, 2., 0., 0., 0.], type=str2list,
    ...
    def _dataset_config():
        ...
        parser.add_argument('--shiftlen', default=-1, type=int)
        parser.add_argument('--max_graph', default=0, type=int)
    ...
    def _base_config():
        ...
        parser.add_argument('--run_mode', default='stack10',
    ...
    parser.add_argument('--experiment_name', default='PPATlong',
    ...
    # code backup
    parser.add_argument('--save_codes', default=["PPATlong_dataset.py",
                                                 "PPATlong_framework.py",
                                                 "PPATlong_model.py",
                                                 "PPATlong_option.py",
                                                 "PPATlong_graph_build.py"],
