...
def option():
    ...
    def _model_config():
        ...
        parser.add_argument('--layer_intra_loss_weight', default=[2, 6., 0., 0., 0.],
    ...
    parser.add_argument('--experiment_name', default='RRGCATbert',
    ...
    # code backup
    parser.add_argument('--save_codes', default=["RRGCATbert_dataset.py",
                                                 "RRGCATbert_framework.py",
                                                 "RRGCATbert_model.py",
                                                 "RRGCATbert_option.py",
                                                 "RRGCATbert_graph_build.py"],
