...
from RRGCATbert_dataset import get_dataloader
from RRGCATbert_model import RRGCATbert_model
...
class RRGCATbert_framework(BaseFramework):
    ...
    def __model_initial(self):
        ...
        opt = self.opt
        model = RRGCATbert_model(opt.model_config, self.logger)
    ...
    def __dataloader_initial(self):
        ...
        cuda_renter = CudaApplication(40000, opt.device)
...
def main(opt):
    ...
    framework = RRGCATbert_framework(opt)
